...
mongoose
    ...
    .then(() => {
        ...
        console.log("error connecing to database");
    });
...
server.listen(process.env.PORT || 3000, () => console.log("Server is up and running at 3000"));


//./mongod --dbpath=/Users/91988/MongoDB-data
